        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form>
            <input
              ...
              onChange={onChange}
              className={`mb-6 w-full px-4 py-2 text-xl text-green-700 bg-white border border-gray-300 rounded transition ease-in-out ${
          ...
          <>
            ...
            <ul>
              {listings.map((listing) => (
                <List key={listing.id} id={listing.id} listing={listing.data} />
              ))}
            </ul>
          </>
        )}
